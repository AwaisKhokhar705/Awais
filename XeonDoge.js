//-----(Awais Bot by Khokhar Bot Inc.)-----\\
//-----(Youtube Channel: Awais)-----\\
//-----(Whatsapp number: +923417888643)-----\\
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
        ...
        const grupinv = (teks) => {
        	grup = alpha.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/CrqTjRXLkpj23yiGJSxwEC', "groupName": `Awais Bot Inc.`, "footerText": "*Khokhar Bot*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		...
		const reply = (teks) => {
			alpha.sendMessage(from, teks, text, { thumbnail: ofrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Doge Bot`,body:"HORNY = BONK",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/6349482305092740/923417888643`}}})
		}
		const simir = (teks) => {
...
if(isButton == 'igm'){
reply('https://github.com/AwaisKhokhar705')
}
if(isButton == 'ytm'){
reply('wa.me/+923417888643')
}
...
──────────────────
*👇SCRIPT GITHUB LINK👇*
https://github.com/AwaisKhokhar705
_BASE : Awais Bot Inc._
_ORI SCRIPT : Awais Bot Version 2_
_OWNER : ${NamaOwner}_
⍟ ────────────────── ⍟`
buttons = [
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "https://github.com/AwaisKhokhar705"
        },
        "index": 0
      }
    ]
